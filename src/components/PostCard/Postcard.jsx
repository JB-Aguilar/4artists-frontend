...
function Postcard({post}) {
  ...
  return (
    <div className=" flex flex-col flex-shrink-0 antialiased  text-gray-800">
      <div className=" relative ml-auto w-full max-w-[50rem] mt-5 bg-blue-100 flex-col mr-auto bg-transparent bg-clip-border text-grey-700 shadow-md mb-5">
        <div className="relative mx-0 mt-4 flex items-center gap-4 overflow-hidden rounded-xl bg-transparent bg-clip-border pt-0 pb-8 text-gray-700 shadow-none">
          ...
          <div className="flex w-full flex-col gap-0.5">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center pr-5 gap-0"><LastSeen date={post.createdAt} /></div>
            </div>
          </div>
        </div>
