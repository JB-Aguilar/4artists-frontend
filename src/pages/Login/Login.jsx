    ...
    <div className="py-6">
      <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://cdn.leonardo.ai/users/f9f90d9e-2f59-4409-87bb-dfc299905238/generations/76342931-1351-4e66-a439-5e212775feaa/variations/Default_a_half_body_portrait_of_a_woman_as_made_of_water_half_3_76342931-1351-4e66-a439-5e212775feaa_1.jpg')",
          }}
        ></div>
        <div className="w-full p-8 lg:w-1/2">
          ...
          <div className="mt-8">
            <button
              ...
              className="bg-indigo-600 text-white font-bold py-2 px-4 w-full rounded hover:bg-gray-600"
            >
              Login
            </button>
          </div>
